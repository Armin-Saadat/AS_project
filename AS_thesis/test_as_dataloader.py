...
from dataloader.utils import visualize_as_video
from dataloader.as_dataloader_revision import AorticStenosisDataset
...
if multiple:
    ...
    # try running the cine on slowfast model
